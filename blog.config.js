...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '李达生', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '产品经理&通用人工智能', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pmandagi.top', // 网站地址
